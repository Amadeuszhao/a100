...
NUM_CLASSES = 100
WEIGHT_DECAY = 1e-4
MODEL_PATH ='/data/plum/model_train/models'
opt =  tf.keras.optimizers.Adam(lr=0.01, beta_1=0.9,beta_2=0.999, decay = 1e-8)
...
model = InceptionV3(weights=None, include_top=True, input_shape=(IMAGE_SIZE, IMAGE_SIZE, 3),classes=100)
model.summary()
...
learning_rate_reduction = ReduceLROnPlateau(monitor='val_accuracy', patience=3, verbose=1, factor=0.1, min_lr=0.00000001)
