...
chechpointer = ModelCheckpoint(os.path.join(MODEL_PATH, 'vgg16/vgg16_cifar10_{epoch:03d}_{val_accuracy:04f}.h5'),monitor='val_accuracy',save_weights_only=False,period=1,save_best_only=True)
