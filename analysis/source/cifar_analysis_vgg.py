...
from cifar_solver_vgg import solver
...
DATA_PATH = DATA_DIR + 'vgg16_adv_list.npy'
MODEL_DIR = '../models'  # model directory
MODEL_FILENAME = 'vgg19_cifar100_022_0.588000.h5'  # model file
...
def start_analysis():
    ...
    analyzer = solver(
        model,
        verbose=False, mini_batch=MINI_BATCH, batch_size=BATCH_SIZE,data_path=DATA_PATH)
